...
class ProductsModel {
    ...
    func fetchProducts() async {
        ...
        products.removeAll()
        let url = URL(string: "http://10.14.255.52:4000/products")!
    ...
    func deleteProduct(product: Product) async {
        ...
        let url = URL(string: "http://10.14.255.52:4000/delete-product/\(product.productId)")!
    ...
    func addProduct(product: Product) async {
        ...
        let url = URL(string: "http://10.14.255.52:4000/add-product")!
    ...
    func updateProduct(product: Product) async {
        ...
        let url = URL(string: "http://10.14.255.52:4000/update-product/\(product.productId)")!
